...
page "/blog/archive.html", :layout => :blog_index, :layout_engine => 'haml'
page "/blog/rss.xml", :layout => false
page "/blog/*", :layout => :blog_post, :layout_engine => 'haml'

page "/other-blog/index.html", :layout => :blog_index, :layout_engine => 'haml'
page "/other-blog/archive.html", :layout => :blog_index, :layout_engine => 'haml'
page "/other-blog/rss.xml", :layout => false
page "/other-blog/*", :layout => :blog_post, :layout_engine => 'haml'
